...
__usage__= """visualize.py <DETECTIONS_DIR> <PATH_TO_IMG> <OUTPUT_DIR>"""
...
def visualize(multi_detections, fnImage, fnOut):
...
for file in glob.glob( os.path.join( DETECTIONS_DIR, '*.detects' ) ):
	print "\n--------------------------------------------------"
	...
	visualize( detections, fnImage, fnOut)
